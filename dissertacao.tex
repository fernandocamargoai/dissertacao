\documentclass[dissertacao, abnt, nocolorlinks]{inf-ufg}
...
\titulo{Aplicação de Meta Heurísticas na Otimização Multiobjetivo de Sistemas Hidrotérmicos}
...
%-------------------------------------------------------------- ORIENTADOR %
\orientador{Gélson da Cruz Júnior, Doutor}
\orientadorR{CRUZ JÚNIOR, G.}
...
\arial
\bibliography{./bib/dissertacao} %%% Nomes dos seus arquivos .bib
\label{ref-bib}
