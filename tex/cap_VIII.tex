...
\begin{table}[h]
\caption{Mediana e Desvio Padrão do Indicador Epsilon Aditivo (\textit{I}$^{1}_{\epsilon+}$) do primeiro período}
\label{table:epPeriodo1}
\centering
\begin{tabular}{ll}
    ~                             & Mediana e Desvio Padrão                   \\ \hline
...
\begin{table}[h]
\caption{Mediana e Desvio Padrão do Indicador SPREAD ($\Delta$) do primeiro período}
...
\begin{table}[h]
\caption{Mediana e Desvio Padrão do Indicador de Hipervolume (HV) do primeiro período}
...
Ao observarmos os resultados desse indicador, notamos que novamente os algoritmos evolucionários foram obtiveram melhores resultados que os de enxame de partículas. Porém, esse indicador muda um pouco a ordem dos melhores algoritmos. Nesse caso, o NSGA-II foi obteve o melhot resultado de todos, sendo seguido, dessa vez, pelo SPEA2 e por último o MOCell, que havia obtido os melhores resultados de acordo com as métricas anteriores. Porém, a diferença dos resultados desses três algoritmos é pequena de acordo com essa métrica.

Voltando nossa atenção aos algoritmos de enxame de Partículas, notamos que novamente o OMOPSO superou seu sucesso, SMPSO. Seu resultado foi razoavelmente melhor nessa métrica, assim como na \textit{I}$^{1}_{\epsilon+}$. Isso indica que, em relação a seu antecessor, o SMPSO conseguiu ser melhor apenas na distribuição das soluções nesse problema em específico.
...
\begin{sidewaysfigure}[h]
  \centering
  \caption{Frentes de Pareto das Medianas do Indicador \textit{I}$^{1}_{\epsilon+}$ do primeiro período}
...
\begin{sidewaysfigure}[h]
  \centering
  \caption{Frentes de Pareto das Medianas do Indicador $\Delta$ do primeiro período}
...
\begin{sidewaysfigure}[h]
  \centering
  \caption{Frentes de Pareto das Medianas do Indicador HV do primeiro período}
...
\begin{table}[h]
\caption{Mediana e Desvio Padrão do Indicador Epsilon Aditivo (\textit{I}$^{1}_{\epsilon+}$) do segundo período.}
...
\begin{table}[h]
\caption{Mediana e Desvio Padrão do Indicador SPREAD ($\Delta$) do segundo período}
...
\begin{table}[h]
\caption{Mediana e Desvio Padrão do Indicador de Hipervolume (HV) do segundo período}
...
\begin{sidewaysfigure}[h]
  \centering
  \caption{Frentes de Pareto das Medianas do Indicador \textit{I}$^{1}_{\epsilon+}$ do segundo período}
...
\begin{sidewaysfigure}[h]
  \centering
  \caption{Frentes de Pareto das Medianas do Indicador $\Delta$ do segundo período}
...
\begin{sidewaysfigure}[h]
  \centering
  \caption{Frentes de Pareto das Medianas do Indicador HV do segundo período}
  \resizebox{\columnwidth}{!}{\input{./fig/Frente-de-Pareto_HV_2.pdf_tex}}
  \label{fig:paretoHV2}
\end{sidewaysfigure}

A primeira análise que podemos observar nessas figuras é que elas deixam claro a maior facilidade em resolver otimizar para esse segundo período. A própria Frente de Pareto de referência obteve valores maiores de 82\% de armazenamento final, enquanto otimizava o custo térmico. Inclusive, muitos resultados se encontraram muito próximos de 100\% de armazenamento. Mesmo na Figura \ref{fig:paretoSPREAD2}, que avalia a distribuição das soluções, os valores não foram mais baixos do que 70\%. Isso comprova que realmente os algoritmos tiveram maior facilidade na solução desse problema.
...
\begin{table}[h]
\caption{Mediana e Desvio Padrão do Indicador Epsilon Aditivo (\textit{I}$^{1}_{\epsilon+}$) do terceiro período}
...
\begin{table}[h]
\caption{Mediana e Desvio Padrão do Indicador SPREAD ($\Delta$) do terceiro período}
...
\begin{table}[h]
\caption{Mediana e Desvio Padrão do Indicador de Hipervolume (HV) do terceiro período}
...
\begin{sidewaysfigure}[h]
  \centering
  \caption{Frentes de Pareto das Medianas do Indicador \textit{I}$^{1}_{\epsilon+}$ do terceiro período}
...
\begin{sidewaysfigure}[h]
  \centering
  \caption{Frentes de Pareto das Medianas do Indicador $\Delta$ do terceiro período}
...
\begin{sidewaysfigure}[h]
  \centering
  \caption{Frentes de Pareto das Medianas do Indicador HV do terceiro período}
